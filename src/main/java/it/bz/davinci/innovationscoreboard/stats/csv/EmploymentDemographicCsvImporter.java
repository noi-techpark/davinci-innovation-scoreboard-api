...
public class EmploymentDemographicCsvImporter extends StatsCsvImporter<EmploymentDemographicCsv, EmploymentDemographicEs> {
    ...
    public EmploymentDemographicCsvImporter(FileImportService fileImportService, EsDao<EmploymentDemographicEs> esDao, ApplicationEventPublisher publisher) {
        super(fileImportService, esDao, EmploymentDemographicCsv.class, EmploymentDemographicMapper.INSTANCE, publisher);
    }
}
